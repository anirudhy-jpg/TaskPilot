...
import { signupSchema, loginSchema, SignupInput, LoginInput } from "@/validation/auth.validation"
...
export class AuthService {
  static async signUp(input: SignupInput) {
    ...
    try {
      ...
      console.error("Failed to create user profile, but auth user was created:", profileError)

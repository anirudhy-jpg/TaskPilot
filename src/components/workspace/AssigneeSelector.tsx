...
import { getUserInitials, getAvatarBgColor } from "./KanbanBoard";
        ...
        >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-2.5 py-2 text-left rounded-lg text-xs font-semibold hover:bg-zinc-900 transition-colors cursor-pointer ${
              !task.assigneeId ? "bg-amber-500/10 border border-amber-500/25 text-amber-200" : ""
            }`}
          >
            <div className="w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center text-zinc-400">
              <User size={12} />
            </div>
            <span className="text-zinc-355 font-bold">Unassigned</span>
          </button>
          ...
          >
            ...
            <span className="text-zinc-355 font-bold">Automatic</span>
          </button>

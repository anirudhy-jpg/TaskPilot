              ...
              <div className="flex items-center justify-between gap-3 mb-3">
                ...
                {!isWorkspaceMember && (
                  <button
                    ...
                    className="p-1 rounded-lg text-slate-350 hover:text-red-505 hover:bg-red-50 border border-transparent hover:border-red-100 transition-all cursor-pointer"
